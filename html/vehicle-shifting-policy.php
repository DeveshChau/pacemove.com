...
<!-- header start form here -->
            <div class="row "style = "margin-top: 81px;">
               ...
               <div class="col-sm-12">
                  <h2>Vehicle Shifting Policy</h2>
                  <li> You have to make payment according to the payment terms of the accepted quotation.

					Delay in the payment from your side can cause a delay in the shipment. PACEMOVE or its Partner
					
					won’t be responsible for it.</li>
					
					<li>  You are advised not to entertain any kind of tip requests of PACEMOVE Partner personals.</li>
					
					<li>PACEMOVE Partner personal will visit your place to collect the vehicle.</li>
					...
					Certificate and Owner Identity Proof. *For some regions, they require original documents.</li>
					...
					can go up-to <span style="font-weight:400">150 kms or more.</span></li>
					
					<li> <span style="font-weight:400">16 ltr petrol/diesel</span> should be available in the vehicle. In case of excess fuel, it would be
					
					drained out for safety purpose. You will get the vehicle with an almost empty fuel tank.</li>
					
					<li> You <span style="font-weight:400">should not put any items/belongings</span> inside the vehicle. If there is any such
					...
					<li> Other terms &amp; conditions are applicable as mentioned in Goods Consignment Note.</li>
					
					<li> You might find your vehicle in little-bit dirty condition from outside at the time of delivery,
					
					since it can be driven on roads for pickup and delivery purposes.</li>
					
					<li> In case of an electric vehicle, it is compulsory for a customer to hand over the vehicle in fully-
					
					charged condition. The vehicle can be charged by Partner before delivery also.</li>
					
					<li> You should examine vehicle&#39;s condition at the time of delivery <span style="font-weight:400">before signing on delivery
					
					confirmation receipt.</span> If any complaint has to be registered, it should be done <span style="font-weight:400">at the time of
					
					delivery </span>only. A complaint should be registered by sending a mail to support@PACEMOVE.in with
					
					the attached images of the vehicle.</li>
