...
<!-- header start form here -->
            <div class="row "style = "margin-top: 81px;">
            	...
            	<div class="col-sm-12">
					...
					<p>If you choose to give your name and email address into one or more of our site's inquiry forms, we will send you emails relating to the inquiry generated by you. You may opt out of receiving future mailings from our mailing lists by calling Pacemove Support 888 830 82 18.</p>
                  ...
                  <p class="sub-text uppercase">BY USING OUR SERVICES OR BY OTHERWISE GIVING US YOUR INFORMATION, YOU AGREE TO THE TERMS OF THIS PRIVACY POLICY.</p>
                  ...
                  <h4 class="uppercase m-t-20">(b) INFORMATION WE COLLECT AS YOU ACCESS AND USE OUR SERVICES</h4>
                     <div class="indented">
                        <p class="sub-text">
                  ...
                  <h4 class="uppercase m-t-20">(c) INFORMATION THIRD PARTIES PROVIDE ABOUT YOU</h4>
                     <div class="indented">
                        <p class="sub-text">
                  ...
                  <h4 class="uppercase m-t-20">(d) INFORMATION COLLECTED BY MOBILE APPLICATIONS</h4>
                     <div class="indented">
                        <p class="sub-text">
                        ...
                        <ul class="items-list">
                           ...
                           <li>To prevent, discover and investigate violations of this Privacy Policy or any applicable terms of service or terms of use for the Mobile Application, and to investigate fraud, chargeback or other matters</li>
                  ...
                  <h3 class="uppercase m-t-30">2. USE OF INFORMATION COLLECTED</h3>
                     <div class="indented">
                        <p class="sub-text">
                        ...
                        <p class="sub-text">
                           ...
                           <ul class="items-list list-as-numbers">
                              ...
                              <li>to enable you to participate in a variety of the Services’ features such as online or mobile entry sweepstakes, contests or other promotions</li>
                              ...
                              <li>for inclusion in our data analytics and</li>
                     ...
                     <h3 class="uppercase m-t-30">3. HOW AND WHEN DO WE DISCLOSE INFORMATION TO THIRD PARTIES?</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h4 class="uppercase m-t-20">(a) WHEN YOU AGREE TO RECEIVE INFORMATION FROM THIRD PARTIES.</h4>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h4 class="uppercase m-t-20">(b) THIRD PARTIES PROVIDING SERVICES ON OUR BEHALF.</h4>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h4 class="uppercase m-t-20">(c) CO-BRANDED SERVICES..</h4>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h4 class="uppercase m-t-20">(d) CONTESTS AND PROMOTIONS.</h4>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h4 class="uppercase m-t-20">(e) ADMINISTRATIVE AND LEGAL REASONS.</h4>
                     <div class="indented">
                        <p class="sub-text">
                           ...
                           <ul class="items-list list-as-romans">
                              ...
                              <li>to detect, prevent or otherwise address fraud, security or technical issues; an /or</li>
                              <li>to prevent or stop activity we may consider to be, or to pose a risk of being, an illegal, unethical, or legally actionable activity. Further, we may use IP address or other Device Identifiers, to identify users, and may do so in cooperation with third parties such as copyright owners, internet TSPs, wireless TSPs and/or law enforcement agencies, including disclosing such information to third parties, all in our discretion. Such disclosures may be carried out without notice to you.</li>
                           </ul>
                        </p>
                     </div>

                     <h4 class="uppercase m-t-20">(f) BUSINESS TRANSFER..</h4>
                     <div class="indented">
                        <p class="sub-text">
                           ...
                           <ul class="items-list list-as-romans">
                              <li>to a subsequent owner, co-owner or operator of the Services or applicable database. or</li>
                              <li>in connection with a corporate merger, consolidation, restructuring, the sale of substantially all of our membership interests and/or assets or other corporate change, including, during the course of any due diligence process.</li>
                           </ul>
                        </p>
                     </div>

                     <h3 class="uppercase m-t-30">4. ONLINE BEHAVIOURAL ADVERTISING</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h3 class="uppercase m-t-30">5. THIRD PARTY CONTENT AND LINKS TO THIRD PARTY SERVICES</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h3 class="uppercase m-t-30">6. SOCIAL MEDIA FEATURES AND WIDGETS</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h3 class="uppercase m-t-30">7. CHANGE OF INFORMATION AND CANCELLATION OF ACCOUNT</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h3 class="uppercase m-t-30">8. SECURITY</h3>
                     <div class="indented">
                        <p class="sub-text">
                     ...
                     <h3 class="uppercase m-t-30">9. CHANGES TO THE PRIVACY POLICY</h3>
                     <div class="indented">
                        <p class="sub-text">
