...
<button type="button" class="btn btn-primary  btn-lg " id="callback-submit">Submit</button>
				...
				<nav class="nav">
					<ul class="navul">
						...
						<li class="active"><a href="../html/blog.php">Blog</a></li>
...
<footer>
	...
	<script type="text/javascript" src="../code/js/jquery-3.3.1.min.js"></script>
	
	<script type="text/javascript" src="http://ajax.cdnjs.com/ajax/libs/json2/20110223/json2.js"></script>
	<script type="text/javascript" src="../code/js/validator.js"></script>
	...
	<script type="text/javascript" src="../code/js/select.js"></script>
