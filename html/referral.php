...
<button type="button" class="btn btn-primary  btn-lg " id="callback-submit">Submit</button>
				...
				<nav class="nav">
					<ul class="navul">
						...
						<li class="active"><a href="../html/referral.php">Referral</a></li>
...
<section class="about_page_banner">
   <div class="contanear">
		<h3>GET Rs 500/- PAYTM CASH ON REFERRALS</h3>
	</div>
...
<!-- header start form here -->
            <div class="row "style = "margin-top: 81px;">
            	...
            	<div class="col-sm-12">
            		<h2>PACEMOVE REFERRALS</h2>
            		<p class="sub-text">Pacemove offers 500 Rs/- Paytm Cash on refferals.</p>
            		
            		<p>Suggest Pacemove Services to your friends, family members, business partner, and colleague. And get Rs. 500/- Paytm Cash From Pacemove. We provide home shifting, corporate shifting, vehicle shifting, logistics and warehousing services. We not only move goods but spread happiness too. </p>
