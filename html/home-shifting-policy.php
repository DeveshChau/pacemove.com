...
<!-- header start form here -->
            <div class="row "style = "margin-top: 81px;">
            	...
            	<div class="col-sm-12">
        			...
        			<li>
						Household goods like Split AC, Kitchen Chimney, Any kind of fan,  Wall-mounted TV, Geyser, Wall-mounted Water Purifier/R.O., Hydraulic Bed will <span style="font-weight:400">not be dismantled and assembled </span>by PACEMOVE Partner. You are advised to keep all these items dismantled before the shifting date.
        		   </li>
        			<li>
        				Any kind of skilled job such as Carpentry, Electrician and Plumber etc. will not be done by PACEMOVE Partner.
        			</li>
        			<li>
						Cartons and packing materials are properties of the PACEMOVE Partner.Customer has to <span style="font-weight:400">return the cartons and packing material</span> to the PACEMOVE Partner immediately after delivery.In case, customer wants to keep the cartons and packing material, extra charges need to be paid to the PACEMOVE Partner.
					</li>
					<li>
					...
					<li> You should examine shipment&#39;s condition at the time of delivery <span style="font-weight:400">before signing on delivery
					...
					the attached images of the goods.</li>
					<li>Part Truck Load (Sharing) shipments might take 3 to 5 days or more to load and dispatch from the pickup city based on the availability of the transport services.</li>
