...
<section class="banner_panel">
	...
	<div class="contanear">
		...
		<a href="http://pacemove.com/code/details.php">Start Your Move</a>
...
<section class="step_panel">
  ...
  <div class="contanear">
	...
	<h2>3 simple steps to move your home!</h2>
	  		<article>
			<div class="step_panel_box">
				<div class="step_panel_box_left">1.</div>
				<div class="step_panel_box_right">Enter Origin & Destination</div>
		 	</div>
			<img src="../html/images/step-arrow.png"  alt="" class="step_panel_arrow"/>
	 		 ...
	 		 <article>
	  		<div class="step_panel_box">
				<div class="step_panel_box_left">2.</div>
				<div class="step_panel_box_right">Select Articles to be moved</div>
		 	</div>
			<img src="../html/images/step-arrow.png"  alt="" class="step_panel_arrow"/>
	  			</article>
	 		 ...
	 		 <article>
	  		<div class="step_panel_box">
				<div class="step_panel_box_left">3.</div>
				<div class="step_panel_box_right">Make Payment</div>
		 	</div>
	  	</article>
...
<section class="why_choose_us_panel">
		...
		<div class="why_choose_us_panel_left">
				...
				<h2>Why Choose from us?</h2>
	
				<p class="animate" data-animate="bounceIn" data-duration="1s" data-delay="0s"><img src="../html/images/ftr-ico1.png" alt=""/> <span>DIRECT SERVICE.</span> We believe in providing direct service to the customer without involving the vendors to give the best service.</p>
			
				<p class="animate" data-animate="bounceIn" data-duration="1s" data-delay="0.2s"><img src="../html/images/ftr-ico4.png" alt=""/> <span>DEDICATED MOVE CO-ORDINATOR.</span> We assign a dedicated move co-ordinator who will always be in contact with you while the relocation process. </p>

                                <p class="animate" data-animate="bounceIn" data-duration="1s" data-delay="1s"><img src="../html/images/ftr-ico3.png" alt=""/> <span>TRANSPARENT PRICING.</span>We charge only for what we deliver there are no hidden charges.</p>

				<p class="animate" data-animate="bounceIn" data-duration="1s" data-delay="0.8s"><img src="../html/images/ftr-ico2.png" alt=""/> <span>REAL-TIME MONITORING.</span> We will keep you updated with your move and give timely update while you can sit and relax at your place.</p>
			
				<p class="animate" data-animate="bounceIn" data-duration="1s" data-delay="0.4s"><img src="../html/images/ftr-ico1.png" alt=""/> <span>SUPERIOR CUSTOMER SUPPORT.</span> We provide 24*7 customer support for any or every need of the customer. Customer satisfaction is what we believe in.
</p>
...
<section class="about_panel">
	...
	<div class="contanear">
		...
		<p><strong>PACEMOVE, moving goods and happiness. </strong></p>
		...
		<p>PACEMOVE is bounded for the On-time delivery, Utmost care in packaging, Overall interaction, and Responsiveness. We are always reasonable with our pricing. Pacemove is the ultimate one-stop solution for the relocation and logistics service in Pune.</p>
	</div>
...
<section class="map_panel map_panel_img">
	...
	<div class="map_panel_form">
		<h3>Arrange a pacemove walkthrough at your organization?</h3>
	...
	<div class="contanear">
		...
		<div class="footer_cont">
			<div class="footer_cont_box">
				...
				<ul>
					<li><a href="../html/about_us.php">About us</a></li>
					<li><a href="../html/sitemap.php">Sitemap</a></li>
			...
			<div class="footer_cont_box">
				...
				<ul>
					<li><a href="../html/pune.php">Packers and Movers Pune</a></li>
					<li><a href="../html/../html/pune.php">Packers and Movers Pimpri Chinchwad</a></li>
					<li><a href="../html/pune.php">Relocation service Pune</a></li>
				</ul>
               ...
               <li><a href="insurance-policy.php">Insurance Policy</a></li>
					<li><a href="../html/home-shifting-policy.php">Home Shifting Policy</a></li>
					<li><a href="../html/vehicle-shifting-policy.php">Vehicle Shifting Policy</a></li> 
				</ul>
			</div>
